...
import s from './image-cropper.module.scss';

import { errorToast } from '@/shared/lib';
import { Button, Dialog, DialogContent, DialogFooter, Typography } from '@/shared/ui';
...
export const ImageCropper: FC<ImageCropperProps> = ({
  ...
  const onCropAreaChange = (croppedArea: Area, croppedAreaPixels: Area): void => {
  ...
  return (
    <Dialog open={isOpen} onClose={handleClose} className={clsx(s.dialog, className)}>
      ...
      <DialogFooter>
        ...
        <Button variant="primary" onClick={handleCropConfirm} disabled={!croppedAreaPixels || isProcessing}>
